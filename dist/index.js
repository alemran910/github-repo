...
const personal_info_1 = require("./routes/personal-info");
const address_1 = require("./routes/address");
const family_info_1 = require("./routes/family-info");
...
app.get("/personal-info", (req, res) => {
    res.json((0, personal_info_1.personalInfo)());
});
app.get("/address", (req, res) => {
    res.json((0, address_1.addressInfo)());
});
app.get("/family-info", (req, res) => {
    res.json((0, family_info_1.familyInfo)());
});
app.get("/family-info/father", (req, res) => {
    res.json((0, family_info_1.fatherInfo)());
});
app.get("/family-info/mother", (req, res) => {
    res.json((0, family_info_1.motherInfo)());
});
app.get("/family-info/sister1", (req, res) => {
    res.json((0, family_info_1.sister1Info)());
});
app.get("/family-info/sister2", (req, res) => {
    res.json((0, family_info_1.sister2Info)());
});
app.listen(port, () => {
